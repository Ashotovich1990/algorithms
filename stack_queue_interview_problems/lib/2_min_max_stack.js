...
class MinMaxStack {
    ...
    min() {
       return this.minArr[this.minArr.length - 1] ? this.minArr[this.minArr.length - 1] : null
    }

    max() {
        return this.maxArr[this.maxArr.length - 1] ? this.maxArr[this.maxArr.length - 1] : null;
    }
}
